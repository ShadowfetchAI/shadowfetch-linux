...
Current release: **2.1.0 “Umbra”** (2026-07-26) · Debian Testing derivative · amd64 hybrid ISO

## Download

    https://www.shadowfetch.com/linux/download/shadowfetch-2.1.0-amd64.iso

    4,486,000,640 bytes (4.18 GiB)
    sha256  71ebae6632579b0f5d890dae7fc458edc99d01d0b9c6f28d40cddfaddd6cbe30
...
```sh
curl -O https://www.shadowfetch.com/linux/download/shadowfetch-2.1.0-amd64.iso
curl -O https://www.shadowfetch.com/linux/download/shadowfetch-2.1.0-amd64.iso.asc
...
gpg --verify shadowfetch-2.1.0-amd64.iso.asc shadowfetch-2.1.0-amd64.iso
sha256sum -c <<< "71ebae6632579b0f5d890dae7fc458edc99d01d0b9c6f28d40cddfaddd6cbe30  shadowfetch-2.1.0-amd64.iso"
```
